        ...
        <div className={`flex items-center justify-between h-16 rounded-full px-6 transition-all duration-300 ${scrolled ? 'bg-[#12121A]/95 light:bg-white/95 backdrop-blur-xl border border-white/10 light:border-gray-200/50 shadow-2xl light:shadow-sm' : 'bg-[#12121A]/80 light:bg-white/80 backdrop-blur-md border border-white/5 light:border-gray-200/50 shadow-xl light:shadow-sm'}`}>
          ...
          <div className="flex items-center gap-2 sm:gap-3 md:gap-4">
            <button
              ...
              className="flex text-gray-400 light:text-gray-500 hover:text-white light:hover:text-gray-900 transition-colors items-center justify-center bg-white/5 light:bg-white light:shadow-sm border border-white/5 light:border-gray-200 rounded-full w-9 h-9 sm:w-10 sm:h-10 shrink-0"
            ...
            <a href="#login" className={`hidden sm:flex items-center gap-2 px-5 py-2.5 rounded-[12px] text-xs font-bold active:scale-[0.98] transition-all duration-500 shadow-lg shrink-0 ${isLightMode ? 'bg-[#09090B] hover:bg-black' : 'bg-white hover:bg-gray-100'}`} style={{ color: isLightMode ? '#ffffff' : '#09090b' }}>
              Login
            ...
            {/* Mobile Menu Toggle */}
            <button
              className="md:hidden text-gray-400 light:text-gray-500 hover:text-white light:hover:text-gray-900 p-2 shrink-0"
              ...
              {mobileLinks.map((link) => {
                ...
                return (
                  <a
                    ...
                    className={`flex items-center justify-between p-3 rounded-[20px] transition-all ${isActive ? 'bg-[#0F172A] light:bg-blue-50 border border-blue-900/30 light:border-blue-100' : 'hover:bg-white/5 light:hover:bg-gray-100 border border-transparent'
                      }`}
                  >
                    <div className="flex items-center gap-4">
                      <div className={`w-[52px] h-[52px] rounded-2xl flex items-center justify-center ${isActive ? 'bg-blue-600/20 text-blue-500' : 'bg-[#18181B] light:bg-white border border-white/5 light:border-gray-200 text-gray-400 light:text-gray-500'
                        }`}>
